...
package dk.tbsalling.ais.demoapp;
...
public class AISMessageHandlerDemo implements AISMessageHandler {

	private final NMEAMessageHandler nmeaMessageHandler = new NMEAMessageHandlerImpl(this);
	
	public AISMessageHandlerDemo() {
    }
	...
	public static void main(String[] args) {
		AISMessageHandlerDemo demoApp = new AISMessageHandlerDemo();
		demoApp.runDemo();
	}
