...
public class ShipAndVoyageDataTest {
    ...
    public void canDecode1() {
        ...
        assertEquals(new IMO(9131369), message.getImo());
    ...
    public void canDecode2() {
        ...
        // Act
        AISMessage aisMessage = dk.tbsalling.aismessages.ais.messages.AISMessageFactory.create(now.toInstant(), "Test", tag, nmeaMessage1, nmeaMessage2);
        ...
        assertEquals(new IMO(0), message.getImo());
