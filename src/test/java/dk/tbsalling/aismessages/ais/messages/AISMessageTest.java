...
public class AISMessageTest {
    ...
    public void testEquals() {
        // Arrange
        NMEAMessage nmeaMessage1 = new NMEAMessage("!AIVDM,1,1,,B,13AkSB0000PhAmJPoTMoiQFT0D1:,0*5E");
    ...
    public void canReturnRawNmeaMessages() {
        // Arrange
        NMEAMessage nmeaMessage1 = new NMEAMessage("!BSVDM,1,1,,A,1:02Ih001U0d=V:Op85<2aT>0<0F,0*3B");
        ...
        // Arrange
        NMEAMessage nmeaMessage2a = new NMEAMessage("!BSVDM,2,1,5,A,5:02Ih01WrRsEH57J20H5P8u8N222222222222167H66663k085QBS1H,0*55");
        NMEAMessage nmeaMessage2b = new NMEAMessage("!BSVDM,2,2,5,A,888888888888880,2*38");
