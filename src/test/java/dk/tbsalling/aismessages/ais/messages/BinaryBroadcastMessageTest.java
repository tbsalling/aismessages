...
public class BinaryBroadcastMessageTest {
    ...
    public void canDecodeUnknownApplicationSpecificMessage() {
        ...
        assertEquals(200, ((BinaryBroadcastMessage) aisMessage).getDesignatedAreaCode().intValue());
        assertEquals(10, ((BinaryBroadcastMessage) aisMessage).getFunctionalId().intValue());
