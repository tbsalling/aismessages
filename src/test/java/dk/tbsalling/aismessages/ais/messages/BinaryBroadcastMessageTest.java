...
public class BinaryBroadcastMessageTest {
    ...
    public void canDecode() {
        ...
        // Act
        AISMessage aisMessage = AISMessageFactory.create(null, null, null, nmeaMessage);
        ...
        assertEquals("", message.getBinaryData().toString());
    }
    ...
    public void canDecodeDac265Fi1EmptyPayload() {
        ...
        if (aisMessage instanceof BinaryBroadcastMessage binaryBroadcastMessage) {
            ...
            assertEquals("", binaryBroadcastMessage.getBinaryData().toString());
        }
    }
