...
public class DecoderImplTest {
	...
	public void handlesInvalidMessageCorrectly() {
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("00", 0, null);
	...
	public void canDecodePositionReportClassAScheduled() {
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("1773mj001To8m<TE8;R<nb@p08@B", 0, null);
	...
	public void canDecodePositionReportClassAAssignedSchedule() {
		...
		*/
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("24RjBV0028o:pnNEBeU<pJF>0PT@", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodePositionReportClassAResponseToInterrogation() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("34RjBV0028o:pnNEBeU<pJF>0PT@", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeBaseStationReport() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("4h3Ovk1udp6I9o>jPHEdjdW000S:", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeShipAndVoyageData1() {
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("55Mwm;P09lcEL=OSW798uT4j0lDh8uE8pD00000l1@D274oDN7gUDp4iSp>@00000000000", 2, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeShipAndVoyageData2() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("55MuUD02;EFUL@CO;W@lU=<U=<U10V1HuT4LE:1DC@T>B4kC0DliSp=t888888888888880", 2, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
...
@Test
	public void canDecodeShipAndVoyageData3() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("539S:k40000000c3G04PPh63<00000000080000o1PVG2uGD:0000000000000000000000", 2, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeBinaryBroadcastMessage() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("85MwpKiKf:MPiQa:ofV@v2mQTfB26oEtbEVqh4j1QDQPHjhpkNJ3", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
		...
		assertEquals((Integer) 56, message.getFunctionalIdentifier());
		assertEquals("", message.getBinaryData());
	}
	...
	public void canDecodeInterrogationShortVariant() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("?h3Ovk1GOPph000", 2, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeStandardClassBCSPositionReport() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("B5NJ;PP005l4ot5Isbl03wsUkP06", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
		...
		assertFalse(message.getRaimFlag());
		assertEquals(CommunicationStateType.ITDMA, message.getCommunicationStateSelector());
		assertEquals(Integer.valueOf("393222"), message.getCommunicationState().getValue());
	}
	...
	public void canDecodeDataLinkManagementShortVariant1() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("Dh3Ovk1UAN>4", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeDataLinkManagementShortVariant2() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("Dh3Ovk1cEN>4", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
	...
	public void canDecodeClassBCSStaticDataReportVariant1() {
		...
		EncodedAISMessage encodedAISMessage = new EncodedAISMessage("H42O55lti4hhhilD3nink000?050", 0, null);
		DecodedAISMessage decodedAISMessage = decoder.decode(encodedAISMessage);
		System.out.println(decodedAISMessage.toString());
		...
		assertEquals(Integer.valueOf(0), message.getRepeatIndicator());
		assertEquals(MMSI.valueOf(271041815L), message.getSourceMmsi());
		assertEquals(PartNumberType.B, message.getPartNumber());
		assertNull(message.getShipName());
		assertEquals(ShipType.Passenger, message.getShipType());
		assertEquals("1D00014", message.getVendorId());
		assertEquals("TC6163", message.getCallsign());
		assertEquals((Integer) 0, message.getToBow());
		assertEquals((Integer) 15, message.getToStern());
		assertEquals((Integer) 5, message.getToStarboard());
		assertEquals((Integer) 0, message.getToPort());
		assertEquals(PositionFixingDevice.fromInteger(0), message.getPositionFixingDevice());
	}
