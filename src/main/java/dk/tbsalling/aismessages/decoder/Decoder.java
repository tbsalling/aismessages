...
public class Decoder implements Function<EncodedAISMessage, DecodedAISMessage> {
	...
	static {
		...
		sb.append("\n");
		sb.append("AISMessages v1.08 // Copyright (c) 2011- by S-Consult ApS, Denmark, CVR DK31327490. http://s-consult.dk.\n");
		sb.append("\n");
    ...
    @Override
    public DecodedAISMessage apply(EncodedAISMessage encodedAISMessage) {
		long startTime = System.nanoTime();

		if (! encodedAISMessage.isValid())
		...
		case ShipAndVoyageRelatedData:
			decodedMessage = ShipAndVoyageData.fromEncodedMessage(encodedAISMessage);
			break;
		case PositionReportClassAScheduled:
			decodedMessage = PositionReportClassAScheduled.fromEncodedMessage(encodedAISMessage);
			break;
		case PositionReportClassAAssignedSchedule:
			decodedMessage = PositionReportClassAAssignedSchedule.fromEncodedMessage(encodedAISMessage);
			break;
		case PositionReportClassAResponseToInterrogation:
			decodedMessage = PositionReportClassAResponseToInterrogation.fromEncodedMessage(encodedAISMessage);
			break;
		case BaseStationReport:
			decodedMessage = BaseStationReport.fromEncodedMessage(encodedAISMessage);
			break;
		case AddressedBinaryMessage: 
			decodedMessage = AddressedBinaryMessage.fromEncodedMessage(encodedAISMessage);
			break;
		case BinaryAcknowledge:
			decodedMessage = BinaryAcknowledge.fromEncodedMessage(encodedAISMessage);
			break;
		case BinaryBroadcastMessage:
			decodedMessage = BinaryBroadcastMessage.fromEncodedMessage(encodedAISMessage);
			break;
		case StandardSARAircraftPositionReport:
			decodedMessage = StandardSARAircraftPositionReport.fromEncodedMessage(encodedAISMessage);
			break;
		case UTCAndDateInquiry:
			decodedMessage = UTCAndDateInquiry.fromEncodedMessage(encodedAISMessage);
			break;
		case UTCAndDateResponse:
			decodedMessage = UTCAndDateResponse.fromEncodedMessage(encodedAISMessage);
			break;
		case AddressedSafetyRelatedMessage:
			decodedMessage = AddressedSafetyRelatedMessage.fromEncodedMessage(encodedAISMessage);
			break;
		case SafetyRelatedAcknowledge:
			decodedMessage = SafetyRelatedAcknowledge.fromEncodedMessage(encodedAISMessage);
			break;
		case SafetyRelatedBroadcastMessage:
			decodedMessage = SafetyRelatedBroadcastMessage.fromEncodedMessage(encodedAISMessage);
			break;
		case Interrogation:
			decodedMessage = Interrogation.fromEncodedMessage(encodedAISMessage);
			break;
		case AssignedModeCommand:
			decodedMessage = AssignedModeCommand.fromEncodedMessage(encodedAISMessage);
			break;
		case GNSSBinaryBroadcastMessage:
			decodedMessage = GNSSBinaryBroadcastMessage.fromEncodedMessage(encodedAISMessage);
			break;
		case StandardClassBCSPositionReport:
			decodedMessage = StandardClassBCSPositionReport.fromEncodedMessage(encodedAISMessage);
			break;
		case ExtendedClassBEquipmentPositionReport:
			decodedMessage = ExtendedClassBEquipmentPositionReport.fromEncodedMessage(encodedAISMessage);
			break;
		case DataLinkManagement:
			decodedMessage = DataLinkManagement.fromEncodedMessage(encodedAISMessage);
			break;
		case AidToNavigationReport:
			decodedMessage = AidToNavigationReport.fromEncodedMessage(encodedAISMessage);
			break;
		case ChannelManagement:
			decodedMessage = ChannelManagement.fromEncodedMessage(encodedAISMessage);
			break;
		case GroupAssignmentCommand:
			decodedMessage = GroupAssignmentCommand.fromEncodedMessage(encodedAISMessage);
			break;
		case ClassBCSStaticDataReport:
			decodedMessage = ClassBCSStaticDataReport.fromEncodedMessage(encodedAISMessage);
			break;
		case BinaryMessageSingleSlot:
			decodedMessage = BinaryMessageSingleSlot.fromEncodedMessage(encodedAISMessage);
			break;
		case BinaryMessageMultipleSlot:
			decodedMessage = BinaryMessageMultipleSlot.fromEncodedMessage(encodedAISMessage);
			break;
		case LongRangeBroadcastMessage:
			decodedMessage = LongRangeBroadcastMessage.fromEncodedMessage(encodedAISMessage);
			break;
		default:
