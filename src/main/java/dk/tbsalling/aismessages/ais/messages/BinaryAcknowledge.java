...
public class BinaryAcknowledge extends AISMessage {
	...
	public Integer getSpare() {
        return getDecodedValue(new Supplier<Integer>() {
            ...
            @Override
            public Integer get() {
                return UNSIGNED_INTEGER_DECODER.apply(BinaryAcknowledge.this.getBits(38, 40));
            }
        });
	}
	...
	public Integer getSequence1() {
        return getDecodedValue(new Supplier<Integer>() {
            ...
            @Override
            public Integer get() {
                return UNSIGNED_INTEGER_DECODER.apply(BinaryAcknowledge.this.getBits(70, 72));
            }
        });
	}
	...
	public MMSI getMmsi2() {
        return getDecodedValue(new Supplier<MMSI>() {
            ...
            @Override
            public Boolean get() {
                return BinaryAcknowledge.this.getNumberOfBits() > 72;
            }
        }, new Supplier<MMSI>() {
            @Override
            public MMSI get() {
	...
	public Integer getSequence2() {
        return getDecodedValue(new Supplier<Integer>() {
            ...
            @Override
            public Integer get() {
                return UNSIGNED_INTEGER_DECODER.apply(BinaryAcknowledge.this.getBits(102, 104));
            }
        });
	}
	...
	public MMSI getMmsi3() {
        return getDecodedValue(new Supplier<MMSI>() {
            ...
            @Override
            public Boolean get() {
                return BinaryAcknowledge.this.getNumberOfBits() > 104;
            }
        }, new Supplier<MMSI>() {
            @Override
            public MMSI get() {
	...
	public Integer getSequence3() {
        return getDecodedValue(new Supplier<Integer>() {
            ...
            @Override
            public Integer get() {
                return UNSIGNED_INTEGER_DECODER.apply(BinaryAcknowledge.this.getBits(134, 136));
            }
        });
	}
	...
	public MMSI getMmsi4() {
        return getDecodedValue(new Supplier<MMSI>() {
            ...
            @Override
            public Boolean get() {
                return BinaryAcknowledge.this.getNumberOfBits() > 136;
            }
        }, new Supplier<MMSI>() {
            @Override
            public MMSI get() {
	...
	public Integer getSequence4() {
        return getDecodedValue(new Supplier<Integer>() {
            ...
            @Override
            public Integer get() {
                return UNSIGNED_INTEGER_DECODER.apply(BinaryAcknowledge.this.getBits(166, 168));
            }
        });
	}
