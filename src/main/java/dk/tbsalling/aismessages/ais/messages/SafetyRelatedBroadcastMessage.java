...
public class SafetyRelatedBroadcastMessage extends AISMessage {
     ...
     */
    protected SafetyRelatedBroadcastMessage(MMSI sourceMmsi, int repeatIndicator, NMEATagBlock nmeaTagBlock, NMEAMessage[] nmeaMessages, BitString bitString, String source, Instant received,
